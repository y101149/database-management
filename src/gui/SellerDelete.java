...
public class SellerDelete {
	 ...
	 */
			public void run() {
				try {
					SellerDelete window = new SellerDelete();
	...
	private void initialize() {
		...
		JLabel lblAddAgent = new JLabel("Delete Seller");
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(flag == 0)
				{
					...
					String sql = "delete from sellers where sellerid =" + se.getSellerid();
			...
			public void actionPerformed(ActionEvent e) {
				...
				while(JDBCConnection.next())
				{
					try {
						...
						//System.out.println(se.getContactpersonid());
					} catch (SQLException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
