...
public class PropertyDelete {
	 ...
	 */
			public void run() {
				try {
					PropertyDelete window = new PropertyDelete();
	...
	private void initialize() {
		...
		JLabel lblAddAgent = new JLabel("Delete Property");
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(flag == 0)
				{
					...
					String sql = "delete from properties where propertyid =" + pro.getPropertyid();
					if(m == 0)
					{
